...
<section class=" bg-gray-100 p-10 rounded-lg">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM3 19.235v-.11a6.375 6.375 0 0 1 12.75 0v.109A12.318 12.318 0 0 1 9.374 21c-2.331 0-4.512-.645-6.374-1.766Z" />
        ...
        <form action="student-list.php" method="get">
            <div>
                ...
                <div class="flex rounded-lg shadow-sm">
                    <input type="text" value="<?= isset($_GET['q']) ? $_GET['q']: ""  ?>" required id="hs-trailing-button-add-on-with-icon" name="q" class="py-3 px-4 block w-full border-gray-200 shadow-sm rounded-s-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
    ...
    <div class=" mb-5 !flex justify-end gap-3 items-center">
        <p>Showing result (<?= $countRow['total_student'] ?>)</p>
        <?php if (isset($_GET['q'])): ?>
            : search by '<?= $_GET['q'] ?>'
            <a href="student-list.php" class=" bg-red-100 gap-1 text-red-600 px-2 py-2 rounded-full text-xs flex">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">
                                    ...
                                    <div class="inline-flex flex-col">
                                        <a href="./student-list.php?sort_by=name&order=asc & <?= isset($_GET['q'])? "q=".$_GET['q'] :"" ?>" class=" hover:bg-gray-300 p-0.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-3">
  <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" />
</svg>

                                        </a>
                                        <a href="./student-list.php?sort_by=name&order=desc & <?= isset($_GET['q'])? "q=".$_GET['q'] :"" ?>" class=" hover:bg-gray-300 p-0.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-3">
  <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                ...
                                <th class="px-6 py-3 text-end text-xs font-medium text-gray-500 uppercase">Birthday</th>
                                <th class="px-6 py-3 text-end text-xs font-medium text-gray-500 uppercase">Pocket Money</th>
                        ...
                        <tbody>
                            <?php  while ($row = mysqli_fetch_assoc($query)) : ?>
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium text-gray-800 dark:text-gray-200"><?= date("d M Y",strtotime($row['date_of_birth'])) ?></td>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                            ...
                            <?php if($query->num_rows==0):?>
                                <tr>
                                <td colspan="6" class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200 text-center">There is no student</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
