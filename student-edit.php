    ...
    <form action="./student-update.php" method="post">
        ...
        <div class=" flex flex-col w-1/2 gap-3 mb-8">
            ...
            <div class="">
                ...
                <input value="<?= $student['date_of_birth'] ?>" required type="date" name="date_of_birth" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
            </div>
             ...
             <div class="">
                ...
                <select name="gender_id" class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600 sm:p-4">
                    ...
                    ?>
                        <option <?= $gender['id'] == $student['gender_id'] ? 'selected' : '' ?> value="<?= $gender["id"]; ?>">
                            <?= $gender["type"]; ?>
                        </option>
                    <?php endwhile; ?>
            ...
            <div class="">
                ...
                <select name="nationality_id" value="<?= $row['nationality_id'] ?>" class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600 sm:p-4">
                    <option selected>Open this select menu</option>
                    <?php
