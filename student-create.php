    ...
    <form action="./student-store.php" method="post">
        <div class=" flex flex-col w-1/2 gap-3 mb-8">
            ...
            <div class="">
                ...
                <input required type="date" name="date_of_birth" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
            </div>
